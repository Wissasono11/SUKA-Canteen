    ...
    <form className="space-y-4 max-w-md mx-auto p-6">
      ...
      <div
        className={`relative border rounded p-2 transition-all ${
          focusedInput === "password" ? "ring-2 ring-green-500" : ""
        }`}
      >
        <input
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-green-500 transition-transform active:scale-95"
      ...
      <div
        className={`relative border rounded p-2 transition-all ${
          focusedInput === "confirm" ? "ring-2 ring-green-500" : ""
        }`}
      >
        <input
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form className="space-y-6" action="./login.html">
                    ...
                    {/* <!-- NIM / ID Mahasiswa --> */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">NIM / ID MAHASISWA</label>
                        <input type="text" placeholder="Masukkan NIM/ID anda" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-primary focus:border-transparent transition-all duration-200"/>
                    </div>
                    ...
                    {/* <!-- Submit Button --> */}
                    <button type="submit" className="w-full bg-green-primary hover:bg-green-dark text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 transform hover:scale-[1.02]">
                        Daftar Sekarang
                    </button>
                </form>
